...
public class editarAccion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUltPrecio = new javax.swing.JTextField();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(txtUltPrecio, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(19, 19, 19))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtUltPrecio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public void cargartxt(Accion acc, AccionPK accPK){
    this.accPK=accPK;
    txtNombre.setText(acc.getNombre());
    txtSimbolo.setText(acc.getSimbolo());
    ...
    private void botGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botGuardarActionPerformed
        ...
        acc.setNombre(txtNombre.getText().toString());
        acc.setSimbolo(txtSimbolo.getText().toString());
        acc.setTipo(txtTipo.getText().toString());
        uprecio = Double.parseDouble(txtUltPrecio.getText().toString());
        acc.setUltimoPrecio(uprecio);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editarAccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editarAccion().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtUltPrecio;
